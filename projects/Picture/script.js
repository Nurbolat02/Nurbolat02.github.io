...
const forms = () => {
  ...
  form.forEach(item => {
    item.addEventListener('submit', e => {
      ...
      console.log(api);
      (0,_services_requests__WEBPACK_IMPORTED_MODULE_0__.postData)('https://my-json-server.typicode.com/Nurbolat02/Food/requests', formData).then(res => {
        console.log(res);
...
const showMoreStyles = (trigger, wrapper) => {
  ...
  btn.addEventListener('click', function () {
    (0,_services_requests__WEBPACK_IMPORTED_MODULE_0__.getResource)('https://my-json-server.typicode.com/Nurbolat02/Food/styles').then(res => createCards(res.styles)).catch(error => console.log(error));
    this.remove();
  });
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_sliders_js__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', 'horizontal', '.main-prev-btn', '.main-next-btn');
  (0,_modules_sliders_js__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'vertical');
  ...
  (0,_modules_showMoreStyles_js__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '#styles .row');
